...
(cl:defmethod cl:initialize-instance :after ((m <Enable-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Enable-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tae_datalogger-srv:<Enable-request> is deprecated: use tae_datalogger-srv:Enable-request instead.")))

(cl:ensure-generic-function 'EnableDataLogging-val :lambda-list '(m))
(cl:defmethod EnableDataLogging-val ((m <Enable-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tae_datalogger-srv:EnableDataLogging-val is deprecated.  Use tae_datalogger-srv:EnableDataLogging instead.")
  (EnableDataLogging m))
...
(cl:defmethod cl:initialize-instance :after ((m <Enable-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Enable-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tae_datalogger-srv:<Enable-response> is deprecated: use tae_datalogger-srv:Enable-response instead.")))

(cl:ensure-generic-function 'OutputFileName-val :lambda-list '(m))
(cl:defmethod OutputFileName-val ((m <Enable-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tae_datalogger-srv:OutputFileName-val is deprecated.  Use tae_datalogger-srv:OutputFileName instead.")
  (OutputFileName m))
