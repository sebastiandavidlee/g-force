...
# from moveGroupInterface_Seb import MoveGroupInterface
...
def main(args):
  ...
  try:
    ...
    print "============ Press `Enter` to go to Initial Pose"
    raw_input()   
    ...
    while go:
        ...
        x,y,z = subscriber()
        arTagPosition = [x,y,z]
        endEffectorPosition = UR_Interface.get_current_pose().pose
        error = endEffectorPosition - arTagPosition

        UR_Interface.go_to_Position(arTagPosition, speedScale=1)
        # UR_Interface.go_to_Position(ArTagPosition, speedScale=1, wantWait=True)
        arTagPosition[0] -= 0.002
    ...
    print "============ Completed simulated AR Tag follow"
    print ""
